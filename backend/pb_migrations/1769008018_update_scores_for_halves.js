...
migrate((app) => {
  ...
  // Remove indexes that reference round_id
  ...
  // Add new index on half and pro
  collection.indexes.push("CREATE INDEX idx_scores_half_pro ON hole_score_events (half, pro_id)");
  ...
  // Re-add round index
  collection.indexes.push("CREATE INDEX idx_scores_round_pro ON hole_score_events (round_id, pro_id)");
